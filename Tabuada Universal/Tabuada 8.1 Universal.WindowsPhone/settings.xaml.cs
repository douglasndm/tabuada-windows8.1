...
namespace Tabuada
{
    ...
    public sealed partial class settings : Page
    {
        ...
        private void BtnBuyRemoveAds_Click(object sender, Windows.UI.Xaml.RoutedEventArgs e)
        {
        }

        private void AppBarBtnEmail_Click(object sender, Windows.UI.Xaml.RoutedEventArgs e)
        {
        }
